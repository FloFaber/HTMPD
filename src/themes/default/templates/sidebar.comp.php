<div id="sidebar">
  ...
  <div class="sidebar-item <?= $_SERVER["SCRIPT_NAME"] === "artists.php" ? "active" : "" ?>"><a href="<?= WEBROOT ?? "" ?>/page/artists.php">Artists</a></div>
  <div class="sidebar-item <?= $_SERVER["SCRIPT_NAME"] === "albums.php" ? "active" : "" ?>"><a href="<?= WEBROOT ?? "" ?>/page/albums.php">Albums</a></div>
  <div class="sidebar-item <?= $_SERVER["SCRIPT_NAME"] === "genres.php" ? "active" : "" ?>"><a href="<?= WEBROOT ?? "" ?>/page/genres.php">Genres</a></div>
